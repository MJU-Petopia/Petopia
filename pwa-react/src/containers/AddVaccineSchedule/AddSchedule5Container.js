...
import { addScheduleAsync} from '../../modules/VaccineSchedule';
...
const AddSchedule5Container = ({start_date, end_date, std_term, vaccine_name, pet_id, petlist, addScheduleAsync}) => {
    ...
    const onSubmitted = async (start_date, end_date, std_term, pet_id, vaccine_name) => {
       const data = {
            "startDay": start_date,
    ...
    return (
        <>
            ...
            <Container>
                ...
                <CustomRoundDiv
                    onClick={() => onSubmitted(start_date, end_date, std_term, pet_id, vaccine_name)}
                    height={40} 
                    width={90} 
                    margin={'20px 0 0 0'}>
                    완료
